    ...
    <div className="flex flex-col sm:flex-row gap-4">
      ...
      <main className="w-full sm:w-1/2 md:w-1/2 lg:w-3/4">
        ...
        <div className="space-y-4">
            ...
            <CardBody>
              ...
              <div className="mb-4">
                ...
                <ul className="list-disc list-inside mt-2">
                  ...
                  <li>Worked on production testing tools</li>
                </ul>
              </div>
            </CardBody>
          </Card>
          ...
          <Card className='p-8'>
            <CardBody>
              <h2 className="text-2xl font-bold mb-4">Skill Lists</h2>
              <Divider className="my-4" />
...
export default AboutPage;// import ProfileSidebar from '../../components/ProfileSidebar';
// import StarRating from '../../components/StarRating';
// import ClientBreadcrumbs from '@/components/ClientBreadcrumbs';
